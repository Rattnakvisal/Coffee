                ...
                <section class="p-5">
                    <div class="flex flex-wrap items-end justify-between gap-4">
                        <div>
                            ...
                            <h2 class="mt-1 text-3xl font-black text-[#2f241f]">Attendance Check</h2>
                            <p class="mt-1 text-sm text-[#7a5c4e]">Better form and card layout for quick check-in actions.
                            </p>
                        </div>

                        <a href="{{ route('cashier.index') }}"
                            class="inline-flex items-center gap-2 rounded-xl border border-[#e7d5c9] bg-white px-4 py-2 text-sm font-semibold text-[#5c4438] transition hover:bg-[#fff8f2]">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
                        <article class="rounded-2xl border border-[#eddfd4] bg-white/90 p-4 shadow-sm">
                            <div class="flex items-center justify-between gap-2">
                                <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-slate-500">Today</p>
                            ...
                            <p class="mt-2 text-lg font-black text-[#2f241f]">{{ now()->format('D, d M Y') }}</p>
                        </article>
                        <article class="rounded-2xl border border-[#eddfd4] bg-white/90 p-4 shadow-sm">
                            <div class="flex items-center justify-between gap-2">
                                <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-slate-500">Total Cashiers</p>
                                <span class="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-slate-100 text-slate-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.9">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <p class="mt-2 text-lg font-black text-[#2f241f]">{{ number_format($totalCashiers) }}</p>
                        </article>
                        <article class="rounded-2xl border border-emerald-100 bg-emerald-50/80 p-4 shadow-sm">
                            <div class="flex items-center justify-between gap-2">
                                <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-emerald-700">Checked Today</p>
                            ...
                            <p class="mt-2 text-lg font-black text-emerald-700">{{ number_format($checkedTodayCount) }}</p>
                        </article>
                        <article class="rounded-2xl border border-amber-100 bg-amber-50/80 p-4 shadow-sm">
                            <div class="flex items-center justify-between gap-2">
                                <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-amber-700">Pending</p>
                                <span class="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-amber-100 text-amber-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.9">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9.303 3.376c.866 1.5-.217 3.374-1.949 3.374H4.646c-1.732 0-2.815-1.874-1.949-3.374L10.051 3.38c.866-1.5 3.032-1.5 3.898 0l7.354 12.746Z" />
                                    </svg>
                                </span>
                            </div>
                            <p class="mt-2 text-lg font-black text-amber-700">{{ number_format($pendingTodayCount) }}</p>
                        </article>
                    </div>
                </section>
